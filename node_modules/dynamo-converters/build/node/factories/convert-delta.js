...
exports.createConvertDelta = void 0;

const createConvertDelta = (addSymbol, formAddStatement, formRemoveStatement, formSetStatement) => delta => {
  const addStatements = [];
...
exports.createConvertDelta = createConvertDelta;